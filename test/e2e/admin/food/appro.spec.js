...
describe('Appro', function() {
    ...
    it('should see correct stocks', function() {
        ...
        expect(foodList.getRowText(1)).toMatch(/35 canettes/);
        expect(foodList.getRowText(1)).toMatch(/0,57 € \/ canette/);
        expect(foodList.getRowText(1)).toMatch(/19,92 €/);
        ...
        expect(foodList.getSubRowText(1, 1)).toMatch(/13 canettes/);
        expect(foodList.getSubRowText(1, 1)).toMatch(/0,50 € \/ canette/);
        expect(foodList.getSubRowText(1, 1)).toMatch(/6,48 €/);

        expect(foodList.getSubRowText(1, 2)).toMatch(/Canette de 33 cl de Coca-Cola Light/);
        expect(foodList.getSubRowText(1, 2)).toMatch(/22 canettes/);
        expect(foodList.getSubRowText(1, 2)).toMatch(/0,61 € \/ canette/);
        expect(foodList.getSubRowText(1, 2)).toMatch(/13,44 €/);
    ...
    it('should see correct stocks and prices', function() {
        ...
        expect(foodList.getRowText(1)).toMatch(/Coca-Cola/);
        expect(foodList.getRowText(1)).toMatch(/39 canettes/);
        expect(foodList.getRowText(1)).toMatch(/0,70 € \/ canette/);
        expect(foodList.getRowText(1)).toMatch(/27,12 €/);

        foodList.toggleRow(1);

        expect(foodList.getSubRowText(1, 1)).toMatch(/Canette de 33 cl de Coca-Cola/);
        expect(foodList.getSubRowText(1, 1)).not.toMatch(/Canette de 33 cl de Coca-Cola Light/);
        expect(foodList.getSubRowText(1, 1)).toMatch(/15 canettes/);
        expect(foodList.getSubRowText(1, 1)).toMatch(/0,59 € \/ canette/);
        expect(foodList.getSubRowText(1, 1)).toMatch(/8,88 €/);

        expect(foodList.getSubRowText(1, 2)).toMatch(/Canette de 33 cl de Coca-Cola Light/);
        expect(foodList.getSubRowText(1, 2)).toMatch(/24 canettes/);
        expect(foodList.getSubRowText(1, 2)).toMatch(/0,76 € \/ canette/);
        expect(foodList.getSubRowText(1, 2)).toMatch(/18,24 €/);
